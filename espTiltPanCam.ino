...
void initChannels() {
  ledcSetup(CROTATE, FROTATE, TIMER_WIDTH); // channel 1, 50 Hz, 16-bit width   
  ledcSetup(CTILT, FTILT, TIMER_WIDTH); // channel 2, 50 Hz, 16-bit width  
}

void initServos() {
  ledcAttachPin(STILT, CTILT);   // GPIO 0 assigned to channel 2
  ledcAttachPin(SROTATE, CROTATE);   // GPIO 16 assigned to channel 1
}
